...
class Consumer(io.IO):

  CONSUME_REQUEST_TYPE = request_type.FETCH
  ...
  def parse_message_set_from(self, data):
    ...
    while (processed <= length):
      ...
      messages.append(message.parse_from(data[processed:processed + message_size + 4]))
